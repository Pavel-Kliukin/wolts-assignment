...
const DeliveryCalculator = () => {
  ...
  return (
    <div>
      <div className='w-[270px] sm:w-[400px]'>
        <div className='mt-6 ml-5 w-[40%] max-sm:w-[60%] text-white bg-blue-700 border-2 border-b-0 border-zinc-100 rounded-t-md text-center'>Delivery calculator</div>
      </div>  
      <div className='w-[270px] h-[500px] sm:w-[400px] mb-6 sm:h-[600px] border-4 border-zinc-100 rounded-lg flex flex-col justify-center items-start'>
        ...
        <div 
          ...
          className='w-full h-[10%] flex flex-col items-center'>
